...
import { insertCandidateSchema, insertClientSchema, insertProjectSchema, insertPlacementSchema, insertQuoteSchema, insertTimesheetSchema } from "@shared/schema";
...
export async function registerRoutes(httpServer: Server, app: Express): Promise<void> {
  ...
  app.get("/api/candidates", (_req, res) => {
    res.json(storage.getCandidates());
  });
  ...
  app.get("/api/placements", (_req, res) => {
    res.json(storage.getPlacements());
  });
  ...
  app.get("/api/timesheets", (_req, res) => {
    res.json(storage.getTimesheets());
  });
